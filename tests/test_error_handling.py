...
class TestFrontendViews:
    ...
    def test_meal_plan_list_renders_for_authenticated_user(self, logged_in_django_client):
        response = logged_in_django_client.get('/')
        assert response.status_code == 200

    def test_food_search_page_renders_for_authenticated_user(self, logged_in_django_client):
