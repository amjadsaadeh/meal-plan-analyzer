...
class TestPDFViews:
    ...
    def test_meal_plan_pdf_filename_sanitization(self, authenticated_client):
        ...
        assert (
            ...
            == 'attachment; filename="M_sli-Fr_hst_ck.pdf"'
        )


def _mock_site_with_logo(
    url="/media/logos/custom.png", path="/srv/media/logos/custom.png"
):
...
class TestPDFStylingIntegrity:
    def test_django_url_fetcher_resolves_static(self):
        ...
        with patch(
            "django.contrib.staticfiles.finders.find", return_value="/tmp/test.css"
        ):
